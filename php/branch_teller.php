...
$query = 'SELECT branch_teller.id, branch_teller.counter, branch_teller.name, branch_teller.type, branch_teller.branch_id, branch_queue.branch, branch_teller.window, branch_teller.active FROM branch_teller
JOIN branch_queue ON branch_teller.branch_id = branch_queue.id WHERE branch_teller.branch_id = ? ORDER BY branch_teller.window ASC';  // Using a placeholder for parameterized query
